...
void main(void)
{
	...
	//writeCLKD(0x07, 0x34);	//Enable Loss of Reference (LOR) function and set PFD=24.

//	writeCLKD(0x08, 0x4F);	//Set Normal Operation mode to CP and STATUS Pin to 'Loss of Lock or Loss of Ref (active high)'.
...
//	writeCLKD(0x08, 0x37);	//Set Normal Operation mode to CP and STATUS Pin to 'Loss of Lock or Loss of Ref (active high)'.
	...
	writeCLKD(0x08, 0x0F);	//Set Normal Operation mode to Pump-up and STATUS Pin to 'Loss of Lock or Loss of Ref (active high)'.
	
	//writeCLKD(0x09, 0x40);	//Set CP current to 3.0 mA.
	writeCLKD(0x09, 0x00);	//Set CP current to 0.6 mA.
//	writeCLKD(0x09, 0x40);	//Set CP current to 1.2 mA.
